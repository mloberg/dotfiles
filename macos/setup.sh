...
echo ""
printf "Would you like to set your computer name (as done via System Preferences >> Sharing)?  (y/n): "
read -r response
if [[ $response =~ ^([yY][eE][sS]|[yY])$ ]]; then
  printf "What would you like it to be?: "
  read COMPUTER_NAME
...
# Re-enable: `defaults delete com.apple.LaunchServices LSQuarantine`
...
echo ""
printf "Is the computer using an SSD hard drive?  (y/n): "
read -r response
if [[ $response =~ ^([yY][eE][sS]|[yY])$ ]]; then
